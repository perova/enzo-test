 ...
 * Example
    array(
        'type'       => 'number',
        'heading'    => esc_html__( 'Number field', 'tm-moody' ),
...
*/
if ( ! class_exists( 'Insight_VC_Number' ) ) {

	class Insight_VC_Number {
		...
		public function __construct() {
			if ( class_exists( 'WpbakeryShortcodeParams' ) ) {
				WpbakeryShortcodeParams::addField( 'number', array(
					$this,
					'render',
				), INSIGHT_THEME_URI . '/vc-extend/vc-params/number/functions.js' );
			}
		}
