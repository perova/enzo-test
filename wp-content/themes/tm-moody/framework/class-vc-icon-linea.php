...
if ( ! class_exists( 'Insight_VC_Icon_Linea' ) ) {
	class Insight_VC_Icon_Linea {
		...
		function admin_enqueue_scripts() {
			...
			wp_enqueue_style( 'linea', INSIGHT_THEME_URI . '/assets/fonts/linea/style.css', null, null );
		}
